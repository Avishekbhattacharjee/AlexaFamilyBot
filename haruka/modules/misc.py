...
async def tor_search(event):
	...
	if " " in search_str:
		...
		print(search_str)
		res = requests.get("https://www.limetorrents.info/search/?new=1&s_cat=0&search="+search_str,headers)

	else:
		res = requests.get("https://www.limetorrents.info/search/?search="+search_str,headers)
	...
	for a in source.find_all('a',{'class':'cloud'}):
		# print("https://www.limetorrents.info"+a['href'])
		try:
